...
export default class WarnCommand extends commando.Command {
    ...
    public async run(
        ...
        await member.user.send(`You have been warned in **${msg.guild.name}** for ${reason}`)
            .catch(async () => msg.say("The User's DMs were closed so I could not tell them they were warned"));
